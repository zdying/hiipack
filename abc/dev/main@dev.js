...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppView = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(6);
	Backbone.$ = $;
	var TodoView = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"view\">");t.b("\n" + i);t.b("    <input type=\"checkbox\" class=\"toggle\" ");t.b(t.v(t.f("checked",c,p,0)));t.b(">");t.b("\n" + i);t.b("    <label>");t.b(t.v(t.f("title",c,p,0)));t.b("-mustache</label>");t.b("\n" + i);t.b("    <button class=\"destroy\"></button>");t.b("\n" + i);t.b("</div>");t.b("\n" + i);t.b("<input type=\"text\" class=\"edit\" value=\"");t.b(t.v(t.f("title",c,p,0)));t.b("\">");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"view\">\n    <input type=\"checkbox\" class=\"toggle\" {{checked}}>\n    <label>{{title}}-mustache</label>\n    <button class=\"destroy\"></button>\n</div>\n<input type=\"text\" class=\"edit\" value=\"{{title}}\">", H);return T.render.apply(T, arguments); };
